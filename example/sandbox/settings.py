...
# Generic codes
TELEMETA_COLLECTION_PUBLISHED_CODE_REGEX = '[A-Za-z0-9._-]*'
TELEMETA_COLLECTION_UNPUBLISHED_CODE_REGEX = '[A-Za-z0-9._-]*'
TELEMETA_ITEM_PUBLISHED_CODE_REGEX  = '[A-Za-z0-9._-]*'
TELEMETA_ITEM_UNPUBLISHED_CODE_REGEX  = '[A-Za-z0-9._-]*'

# CREM codes
#TELEMETA_COLLECTION_PUBLISHED_CODE_REGEX  = 'CNRSMH_E_[0-9]{4}(?:_[0-9]{3}){2}'
#TELEMETA_COLLECTION_UNPUBLISHED_CODE_REGEX = 'CNRSMH_I_[0-9]{4}_[0-9]{3}'
#TELEMETA_ITEM_PUBLISHED_CODE_REGEX  = collection_published_code_regex + '(?:_[0-9]{2,3}){1,2}'
#TELEMETA_ITEM_UNPUBLISHED_CODE_REGEX  = collection_unpublished_code_regex + '_[0-9]{2,3}(?:_[0-9]{2,3}){0,2}'
