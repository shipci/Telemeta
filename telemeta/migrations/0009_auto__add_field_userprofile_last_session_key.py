...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_session_key'
        db.add_column('profiles', 'last_session_key',
                      self.gf('telemeta.models.core.CharField')(default=None, max_length=40, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.last_session_key'
        db.delete_column('profiles', 'last_session_key')
    ...
    models = {
        ...
        'telemeta.userprofile': {
            ...
            'last_session_key': ('telemeta.models.core.CharField', [], {'default': 'None', 'max_length': '40', 'null': 'True', 'blank': 'True'}),
