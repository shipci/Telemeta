...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaItemAnalysis.blob_base64'
        db.add_column('media_analysis', 'blob_base64',
                      self.gf('telemeta.models.core.Base64Field')(null=True, db_column='blob', blank=True),
                      keep_default=False)

        # Adding field 'MediaItemAnalysis.file'
        db.add_column('media_analysis', 'file',
                      self.gf('telemeta.models.core.FileField')(default='', max_length=1024, db_column='filename', blank=True),
                      keep_default=False)

        # Deleting field 'MediaItem.auto_period_access'
        db.delete_column('media_items', 'auto_period_access')


    def backwards(self, orm):
        # Deleting field 'MediaItemAnalysis.blob_base64'
        db.delete_column('media_analysis', 'blob')

        # Deleting field 'MediaItemAnalysis.file'
        db.delete_column('media_analysis', 'filename')

        # Adding field 'MediaItem.auto_period_access'
        db.add_column('media_items', 'auto_period_access',
                      self.gf('telemeta.models.core.BooleanField')(default=True),
                      keep_default=False)
    ...
    models = {
        ...
        'telemeta.mediaitemanalysis': {
            ...
            'blob_base64': ('telemeta.models.core.Base64Field', [], {'null': 'True', 'db_column': "'blob'", 'blank': 'True'}),
            'file': ('telemeta.models.core.FileField', [], {'default': "''", 'max_length': '1024', 'db_column': "'filename'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
